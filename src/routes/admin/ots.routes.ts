...
import { GetOTs, GetOT, AssingBudget, CreateOt0, ChangeDateBeginEnd, AceptOrRejectBudget } from "../../controllers/admin/ots.controllers";
...
otsRouterAdmin.put("/accept-budget/:id", verifyAdmin, AceptOrRejectBudget);
