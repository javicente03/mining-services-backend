...
import { CleanRuts, createUser, CreateUsersTest, getUserById, getUsers, getUsersUser, updateUser } from '../../controllers/admin/users.controllers';
import verifyAdmin from '../../utils/verifyAdmin';

const usersAdminRouter = Router();

usersAdminRouter.get('/get', verifyAdmin, getUsersUser);
usersAdminRouter.get('/get-users', verifyAdmin, getUsers);
